...
function dishRows(source, rows, confidence = "高") {
  return rows.map(([name_en, name_zh, price, description_zh, category, taste, cautions, tags], index) => ({
    id: String(index + 1),
    name_en,
    name_zh,
    ...
    source,
    confidence,
    recommendationReason: "来自该餐厅官网/菜单页整理；菜单会随季节调整，到店仍建议核对。",
  }));
}
...
const sydneyCbdRestaurants = [
  {
    id: "syd-nomad",
    name: "NOMAD Sydney",
    nameNote: "中文备注：NOMAD，Surry Hills 现代中东/地中海餐厅。适合分享式小盘、烤炉菜、羊肩、烤鸡和甜品。",
    area: "Sydney CBD",
    ...
    menuSource: "NOMAD Sydney 官网菜单",
    menuVerified: true,
    menuDishes: dishRows("NOMAD Sydney 官网菜单", [
      ["Wood fired flatbread, Persian lime & wattle seed za'atar", "柴火烤扁面包配波斯青柠香料", "$15", "中东风味扁面包，适合开场分享。味道有香料和柠檬清香。", "前菜/面包", ["面香", "香料味", "清爽"], ["含麸质"], ["分享", "开胃"]],
      ["Cannellini bean hummus, spiced lamb, pine nuts", "白豆鹰嘴豆泥配香料羊肉和松子", "$16", "豆泥上配羊肉和松子，适合蘸面包吃。", "前菜/蘸酱", ["豆香", "羊肉香", "坚果香"], ["含坚果", "含羊肉"], ["分享", "招牌风格"]],
      ["Vannella Burrata, green tomato ezme, sorrel", "布拉塔奶酪配青番茄 ezme", "$32", "软奶酪配酸香番茄调味，口感 creamy，适合不想吃辣的人。", "前菜/奶酪", ["奶香", "酸香", "清爽"], ["含奶制品"], ["奶酪", "清爽"]],
      ["Cauliflower blossom, truffle honey, pecorino", "花椰菜配松露蜂蜜和佩科里诺奶酪", "$28", "蔬菜菜，但味道比较浓，有蜂蜜甜味和奶酪咸香。", "蔬菜", ["甜咸", "奶酪香", "松露香"], ["含奶制品"], ["蔬菜", "适合分享"]],
      ["Yellowfin tuna, preserved lemon, radish top zhoug", "黄鳍金枪鱼配腌柠檬和香草辣酱", "$36", "偏清爽的鱼类前菜，通常带一点香草和柠檬味。", "海鲜/生食", ["鲜味", "柠檬酸香", "香草味"], ["生食", "鱼类过敏者避免"], ["海鲜", "清爽"]],
      ["Spatchcock, harissa, toum, guindilla", "小春鸡配哈里萨辣酱和蒜酱", "$55", "烤鸡主菜，harissa 会有辣椒和香料味，能吃一点辣的人更适合。", "主菜/鸡肉", ["烤香", "蒜香", "微辣"], ["可能偏辣", "含鸡肉"], ["主菜", "热食"]],
      ["Milk braised lamb shoulder, chickpea kishk, jalapeno salsa", "牛奶炖羊肩配鹰嘴豆和墨西哥椒莎莎", "$86", "适合多人分享的羊肉主菜，肉味浓，配菜有一点辣味。", "主菜/羊肉", ["羊肉香", "浓郁", "微辣"], ["含奶制品", "可能偏辣"], ["分享", "主菜"]],
      ["Olive oil ice cream sandwich, halva, pistachio, honey", "橄榄油冰淇淋三明治配芝麻糖和开心果", "$26", "甜品，奶香、蜂蜜甜味和坚果香明显。", "甜品", ["甜", "奶香", "坚果香"], ["含奶制品", "含坚果"], ["甜品", "饭后"]],
    ]),
    menuText: "Wood fired flatbread, Persian lime & wattle seed za'atar\nCannellini bean hummus, spiced lamb, pine nuts\nVannella Burrata, green tomato ezme, sorrel\nCauliflower blossom, truffle honey, pecorino\nYellowfin tuna, preserved lemon, radish top zhoug\nSpatchcock, harissa, toum, guindilla\nMilk braised lamb shoulder, chickpea kishk, jalapeno salsa\nOlive oil ice cream sandwich, halva, pistachio, honey",
  },
  {
    id: "syd-aalia",
    name: "AALIA",
    nameNote: "中文备注：AALIA，Martin Place 中东/北非高级餐厅。适合 mezze、海鲜、羊肉、鸭肉和香料菜。",
    area: "Sydney CBD",
    address: "25 Martin Place, Sydney NSW 2000",
    rating: "4.6",
    note: "官网菜单是样本菜单，菜名比较陌生，适合先在 app 里看中文解释。",
    tags: ["中东北非", "高级餐厅", "官网 PDF", "真实菜单"],
    curationReason: "入选原因：官网说明为 two-hatted Middle Eastern restaurant，菜单 PDF 可核验。",
    websiteUri: "https://www.aaliarestaurant.com/menus",
    menuSource: "AALIA 官网 A La Carte PDF",
    menuVerified: true,
    menuDishes: dishRows("AALIA 官网 A La Carte PDF", [
      ["Aalia's Khorasan pita, Rio Vista Agrumato", "AALIA 古麦皮塔饼配橄榄油", "$15", "中东风味皮塔饼，适合开场蘸酱吃。", "前菜/面包", ["面香", "橄榄油香"], ["含麸质"], ["开胃", "分享"]],
      ["Smoked buffalo labneh, beetroot molasses", "烟熏水牛酸奶酪配甜菜糖浆", "$29", "浓稠酸奶酪，酸香和烟熏味明显，适合蘸面包。", "前菜/蘸酱", ["酸香", "烟熏", "奶香"], ["含奶制品"], ["分享", "特色"]],
      ["Tuna rishta, finger lime, caramelised kishk", "金枪鱼 rishta 配手指青柠和焦糖 kishk", "$35", "偏精致的鱼类菜，带青柠酸香。", "海鲜/鱼类", ["鲜味", "酸香", "香料味"], ["鱼类过敏者避免"], ["海鲜", "特色"]],
      ["Lamb neck shawarma, tarator, pickles, Saida saj", "羊颈肉 shawarma 配芝麻酱和酸菜", "$68", "羊肉主菜，肉味浓，芝麻酱和酸菜能解腻。", "主菜/羊肉", ["羊肉香", "芝麻香", "酸香"], ["含芝麻", "含羊肉"], ["主菜", "分享"]],
      ["Murray cod masgouf, dill sabzi, preserved lemon broth", "澳洲 Murray cod 鱼配香草和腌柠檬汤汁", "$68", "鱼肉主菜，柠檬和香草味明显，适合想吃鱼的人。", "主菜/鱼类", ["鱼鲜味", "柠檬酸香", "香草味"], ["鱼类过敏者避免"], ["海鲜", "主菜"]],
      ["Dry aged duck, fesenjan", "干式熟成鸭配石榴核桃酱", "$63/$125", "鸭肉配波斯风味酱汁，通常酸甜、坚果感明显。", "主菜/鸭肉", ["鸭肉香", "酸甜", "坚果香"], ["含坚果", "含鸭肉"], ["主菜", "特色"]],
      ["Skin on fries, sumac spice, tahini mayonnaise", "带皮薯条配 sumac 香料和芝麻酱蛋黄酱", "$16", "薯条配中东香料，适合不想冒险的人。", "配菜", ["咸香", "酥脆", "芝麻香"], ["含芝麻", "油炸"], ["配菜", "稳妥"]],
      ["Milk chocolate tart, Egyptian tea, plum", "牛奶巧克力挞配埃及茶和李子", "", "甜品，巧克力和水果酸甜味。", "甜品", ["甜", "巧克力香", "果酸"], ["含奶制品", "含麸质"], ["甜品", "饭后"]],
    ]),
    menuText: "Aalia's Khorasan pita, Rio Vista Agrumato\nSmoked buffalo labneh, beetroot molasses\nTuna rishta, finger lime, caramelised kishk\nLamb neck shawarma, tarator, pickles, Saida saj\nMurray cod masgouf, dill sabzi, preserved lemon broth\nDry aged duck, fesenjan\nSkin on fries, sumac spice, tahini mayonnaise\nMilk chocolate tart, Egyptian tea, plum",
  },
  {
    id: "syd-hubert",
    name: "Restaurant Hubert",
    nameNote: "中文备注：Restaurant Hubert，Bligh Street 法式餐厅。适合法式蜗牛、鸭肝酱、牛排、鳕鱼、烤鸭和甜品。",
    area: "Sydney CBD",
    address: "15 Bligh Street, Sydney NSW 2000",
    rating: "4.7",
    note: "法语菜名多，现场不好懂；提前看中文解释非常有价值。",
    tags: ["法餐", "爵士氛围", "官网 PDF", "真实菜单"],
    curationReason: "入选原因：官网 PDF 菜单完整，地址和营业信息清楚，是 city 经典法餐。",
    websiteUri: "https://swillhouse.com/venues/restaurant-hubert/",
    menuSource: "Restaurant Hubert 官网 A La Carte PDF",
    menuVerified: true,
    menuDishes: dishRows("Restaurant Hubert 官网 A La Carte PDF", [
      ["Duck Parfait", "鸭肝慕斯/鸭肝酱", "$28", "肝酱口感顺滑，配面包吃，味道浓郁。", "前菜/冷盘", ["浓郁", "奶油感", "肉香"], ["内脏味明显", "含动物肝脏"], ["法餐经典", "分享"]],
      ["Escargots XO", "XO 黄油烤蜗牛", "$39", "法式蜗牛，带黄油和 XO 风味，适合愿意尝试的人。", "前菜/海陆", ["黄油香", "咸鲜", "蒜香"], ["蜗牛不是所有人都能接受"], ["特色", "法餐"]],
      ["Souffle au Gruyere", "格鲁耶尔芝士舒芙蕾", "$35", "蓬松芝士蛋奶菜，奶香很重。", "前菜/奶酪", ["奶香", "芝士味", "松软"], ["含奶制品", "含鸡蛋"], ["法餐", "奶酪"]],
      ["Prime Beef Tartare", "生拌牛肉塔塔", "$36", "生牛肉切碎调味，适合能接受生食的人。", "前菜/牛肉", ["肉香", "酸咸", "清爽"], ["生食", "含牛肉"], ["特色", "慎选"]],
      ["Murray Cod", "Murray cod 鱼配黄酒酱", "$75", "鱼肉主菜，酱汁偏法式浓郁。", "主菜/鱼类", ["鱼鲜味", "酱汁浓郁"], ["鱼类过敏者避免"], ["主菜", "鱼"]],
      ["Boeuf Bourguignon", "勃艮第红酒炖牛肉", "$75", "法式红酒炖牛肉，肉味和酱汁都比较浓。", "主菜/牛肉", ["浓郁", "红酒香", "肉香"], ["含牛肉", "可能含酒精残留"], ["经典", "主菜"]],
      ["Pommes Frites", "法式薯条", "$17", "比较稳妥的配菜，小孩和老人也容易接受。", "配菜", ["咸香", "酥脆"], ["油炸"], ["配菜", "稳妥"]],
      ["Crepes Suzette", "橙香法式薄饼", "$28", "经典法式甜品，橙味、奶香和甜味明显。", "甜品", ["甜", "橙香", "奶香"], ["含奶制品", "含麸质"], ["甜品", "经典"]],
    ]),
    menuText: "Duck Parfait\nEscargots XO\nSouffle au Gruyere\nPrime Beef Tartare\nMurray Cod\nBoeuf Bourguignon\nPommes Frites\nCrepes Suzette",
  },
  {
    id: "syd-le-foote",
    name: "Le Foote",
    nameNote: "中文备注：Le Foote，The Rocks 法式 bistro/wine bar。适合生蚝、蜗牛、牛排薯条、鱼三明治和法式甜点。",
    area: "Sydney CBD",
    address: "101 George Street, The Rocks NSW 2000",
    rating: "4.5",
    note: "在 The Rocks，适合游客；菜单 PDF 可核验，法语菜名需要解释。",
    tags: ["法式小酒馆", "The Rocks", "官网 PDF", "真实菜单"],
    curationReason: "入选原因：官网菜单清楚，有适合游客的地理位置和稳定 bistro 菜。",
    websiteUri: "https://swillhouse.com/venues/le-foote/",
    menuSource: "Le Foote 官网 Restaurant Menu PDF",
    menuVerified: true,
    menuDishes: dishRows("Le Foote 官网 Restaurant Menu PDF", [
      ["Prawn Cocktail", "冷虾鸡尾酒杯", "$26", "冷虾配 Marie Rose 酱，比较经典，适合喜欢虾的人。", "前菜/海鲜", ["虾鲜味", "酱汁酸甜"], ["虾过敏者避免"], ["海鲜", "开胃"]],
      ["Escargots", "香草黄油烤蜗牛", "$36", "法式蜗牛，黄油和香草味明显。", "前菜/法餐", ["黄油香", "香草味"], ["蜗牛口感特殊"], ["法餐", "尝鲜"]],
      ["Tartare de Boeuf", "法式生牛肉塔塔", "$31", "生牛肉配传统调味和面包丁。", "前菜/牛肉", ["肉香", "酸咸"], ["生食", "含牛肉"], ["慎选", "法餐"]],
      ["Le Fish Sandwich", "炸 John Dory 鱼三明治", "$31", "鱼排三明治，配卷心菜和塔塔酱，比较好懂。", "主食/鱼", ["酥脆", "鱼鲜味", "酱香"], ["鱼类过敏者避免", "含麸质"], ["主食", "稳妥"]],
      ["Le Foote Burger", "炭烤牛肉芝士汉堡", "$28", "牛肉汉堡，适合不想点复杂法餐的人。", "主食/牛肉", ["牛肉香", "芝士香"], ["含牛肉", "含奶制品", "含麸质"], ["稳妥", "主食"]],
      ["Aquna Murray Cod", "澳洲 Murray cod 鱼", "$75", "鱼肉主菜，配 sauce vierge 和柠檬，偏清爽。", "主菜/鱼类", ["鱼鲜味", "柠檬清香"], ["鱼类过敏者避免"], ["主菜", "海鲜"]],
      ["Sirloin", "300g 西冷牛排", "$88", "比较直接的牛排，适合想吃肉的人。", "主菜/牛肉", ["牛肉香", "炭烤味"], ["含牛肉"], ["牛排", "主菜"]],
      ["Warm Honey Gateau", "温热蜂蜜蛋糕", "$24", "甜品，蜂蜜和黄油香明显。", "甜品", ["甜", "蜂蜜香", "黄油香"], ["含奶制品", "含麸质"], ["甜品", "饭后"]],
    ]),
    menuText: "Prawn Cocktail\nEscargots\nTartare de Boeuf\nLe Fish Sandwich\nLe Foote Burger\nAquna Murray Cod\nSirloin\nWarm Honey Gateau",
  },
  {
    id: "syd-albertos",
    name: "Alberto's Lounge",
    nameNote: "中文备注：Alberto's Lounge，Surry Hills 意式 trattoria。适合手工意面、章鱼、kingfish、生牛肉/牛排和意式小食。",
    area: "Sydney CBD",
    address: "17-19 Alberta Street, Surry Hills NSW 2010",
    rating: "4.5",
    note: "小而热门的意式餐厅，官网 PDF 有当前主菜线索。",
    tags: ["意餐", "手工意面", "官网 PDF", "真实菜单"],
    curationReason: "入选原因：官网菜单 PDF 可核验，适合 city/Surry Hills 用户想吃意餐。",
    websiteUri: "https://swillhouse.com/venues/albertos-lounge/",
    menuSource: "Alberto's Lounge 官网 Main Menu PDF",
    menuVerified: true,
    menuDishes: dishRows("Alberto's Lounge 官网 Main Menu PDF", [
      ["Pane e Olio", "佛卡夏面包配橄榄油", "$13", "意式面包配橄榄油，适合开场分享。", "前菜/面包", ["面香", "橄榄油香"], ["含麸质"], ["开胃", "分享"]],
      ["Spiedino do Mortadella", "烤 mortadella 肉肠串", "$14 each", "意式肉肠串，咸香肉味明显。", "前菜/肉类", ["咸香", "肉香"], ["含猪肉"], ["小食", "肉类"]],
      ["Crudo di Ricciola", "澳洲 kingfish 生鱼片", "$36", "生 kingfish，配腌茴香、刺山柑和 wasabi。", "海鲜/生食", ["鲜味", "酸香", "微辛"], ["生食", "鱼类过敏者避免"], ["海鲜", "清爽"]],
      ["Insalata di Polpo", "烤澳洲章鱼沙拉", "$32", "烤章鱼配橄榄和毛豆，海鲜味明显。", "海鲜/章鱼", ["鲜味", "炭烤香", "橄榄咸香"], ["海鲜过敏者避免"], ["海鲜", "分享"]],
      ["Bucatini all'Astice", "澳洲小龙虾番茄 bucatini 意面", "$65", "龙虾意面，番茄酱汁和海鲜味。", "意面/海鲜", ["番茄酸香", "海鲜味"], ["甲壳类过敏者避免", "含麸质"], ["意面", "海鲜"]],
      ["Pappardelle al Ragu di Manzo", "牛胫和牛尾肉酱宽面", "$42", "宽面配慢炖牛肉酱，肉味浓。", "意面/牛肉", ["肉香", "浓郁"], ["含牛肉", "含麸质"], ["意面", "主食"]],
      ["Bistecca", "Wagyu 牛排配 bagna cauda 黄油", "$68", "意式牛排，酱汁咸香浓郁。", "主菜/牛肉", ["牛肉香", "黄油香", "咸香"], ["含牛肉", "含奶制品"], ["牛排", "主菜"]],
      ["Polenta", "玉米 polenta 配 dashi 和黄油", "$16", "玉米泥/玉米糊配日式汤底和黄油，适合配主菜。", "配菜", ["玉米甜", "黄油香", "鲜味"], ["含奶制品"], ["配菜", "温和"]],
    ]),
    menuText: "Pane e Olio\nSpiedino do Mortadella\nCrudo di Ricciola\nInsalata di Polpo\nBucatini all'Astice\nPappardelle al Ragu di Manzo\nBistecca\nPolenta",
  },
  {
    id: "syd-bistecca",
    name: "Bistecca",
    nameNote: "中文备注：Bistecca，Sydney CBD 地下意式牛排餐厅。主打佛罗伦萨 T-bone 牛排，适合成年人约会或肉食晚餐。",
    area: "Sydney CBD",
    address: "3 Dalley Street, Sydney NSW 2000",
    rating: "4.7",
    note: "官网说明主打按重量切的 Bistecca alla Fiorentina；18 岁以下不能入内。",
    tags: ["意式牛排", "成年人", "官网说明", "真实菜单线索"],
    curationReason: "入选原因：Liquid & Larder 官网地址、营业和招牌菜说明清楚，是 Sydney CBD 标志性牛排店。",
    websiteUri: "https://www.liquidandlarder.com.au/venues/bistecca/",
    menuSource: "Bistecca 官网招牌菜说明",
    menuVerified: true,
    menuDishes: dishRows("Bistecca 官网招牌菜说明", [
      ["Bistecca alla Fiorentina", "佛罗伦萨式 T-bone 牛排", "", "招牌菜，牛排按重量切，炭火烤到偏 medium-rare。适合喜欢牛排的人。", "主菜/牛排", ["牛肉香", "炭烤味", "肉汁"], ["含牛肉", "通常不适合要全熟的人"], ["招牌", "主菜"]],
      ["White Beans", "白豆配菜", "", "官网提到的 rustic sides 之一，适合配牛排。", "配菜", ["豆香", "温和"], ["豆类过敏少见但需留意"], ["配菜", "温和"]],
      ["Cavolo Nero with Confit Garlic Cream", "黑叶甘蓝配慢煮蒜香奶油", "", "官网提到的配菜，蒜香和奶油味明显。", "配菜/蔬菜", ["蒜香", "奶油香"], ["含奶制品"], ["配菜", "蔬菜"]],
      ["Formaggio", "意式奶酪", "", "饭后奶酪，适合喜欢咸香奶制品的人。", "饭后/奶酪", ["奶香", "咸香"], ["含奶制品"], ["奶酪", "饭后"]],
      ["Italian Dessert", "意式甜品", "", "官网提到餐后有经典意式甜点，具体当天以餐厅为准。", "甜品", ["甜", "奶香"], ["含奶制品和麸质需确认"], ["甜品", "待核验"]],
    ], "中高"),
    menuText: "Bistecca alla Fiorentina\nWhite Beans\nCavolo Nero with Confit Garlic Cream\nFormaggio\nItalian Dessert",
  },
  {
    id: "syd-gidley",
    name: "The Gidley",
    nameNote: "中文备注：The Gidley，King Street 地下美式/经典牛排餐厅。适合 ribeye、汉堡、牛排和复古酒吧氛围。",
    area: "Sydney CBD",
    address: "Basement, 161 King Street, Sydney NSW 2000",
    rating: "4.6",
    note: "官网说明 adults only；招牌偏牛排和 Gidley Burger。",
    tags: ["牛排", "成年人", "官网说明", "真实菜单线索"],
    curationReason: "入选原因：官网地址和招牌 burger/steak 信息清楚，适合 CBD 牛排场景。",
    websiteUri: "https://www.liquidandlarder.com.au/venues/the-gidley/",
    menuSource: "The Gidley 官网招牌菜说明",
    menuVerified: true,
    menuDishes: dishRows("The Gidley 官网招牌菜说明", [
      ["The Gidley Burger", "The Gidley 招牌汉堡", "", "官网说明 lounge 提供的招牌汉堡，适合想点简单主食的人。", "主食/汉堡", ["牛肉香", "芝士/酱汁味"], ["含牛肉", "含麸质"], ["招牌", "主食"]],
      ["Prime Cuts", "高级牛排切块", "", "官网主打 prime cuts，具体切块当天以菜单/服务员说明为准。", "主菜/牛排", ["牛肉香", "炭烤味"], ["含牛肉"], ["牛排", "待确认"]],
      ["Ribeye", "肋眼牛排", "", "The Gidley 常见核心牛排方向，油脂和肉味更明显。", "主菜/牛排", ["牛肉香", "油脂香", "浓郁"], ["含牛肉"], ["牛排", "肉食"]],
      ["Lounge Bar Snacks", "酒吧小食", "", "适合等位或只想轻食，具体内容当天以菜单为准。", "小食", ["咸香"], ["配料需确认"], ["小食", "待确认"]],
      ["Steakhouse Sides", "牛排配菜", "", "牛排店常见配菜，建议到店看当天具体选择。", "配菜", ["咸香", "温和"], ["奶制品需确认"], ["配菜", "待确认"]],
    ], "中高"),
    menuText: "The Gidley Burger\nPrime Cuts\nRibeye\nLounge Bar Snacks\nSteakhouse Sides",
  },
  {
    id: "syd-kid-kyoto",
    name: "Kid Kyoto",
    nameNote: "中文备注：Kid Kyoto，Bridge Lane 现代日式 izakaya。适合日式分享菜、烤串、set menu 和下班后聚餐。",
    area: "Sydney CBD",
    address: "17-19 Bridge Street, Sydney NSW 2000",
    rating: "4.4",
    note: "官网有菜单入口和活动菜品，日式英文菜名对目标用户有解释价值。",
    tags: ["现代日餐", "Izakaya", "官网菜单", "真实菜单线索"],
    curationReason: "入选原因：官网地址、菜单入口和活动菜品公开，位置在 CBD。",
    websiteUri: "https://www.kidkyoto.com.au/menu",
    menuSource: "Kid Kyoto 官网菜单页/活动菜单",
    menuVerified: true,
    menuDishes: dishRows("Kid Kyoto 官网菜单页/活动菜单", [
      ["Pork Cigars", "猪肉脆卷/雪茄卷", "$10 happy hour", "官网 happy hour 提到的 pork cigars，通常是脆皮小食，适合下酒。", "小食/猪肉", ["酥脆", "肉香"], ["含猪肉", "油炸"], ["小食", "下酒"]],
      ["Yama Yama's", "Yama Yama 特色小食/饮品", "$10 happy hour", "官网 happy hour 提到的项目，具体内容需到店核对。", "小食/待确认", ["咸香"], ["内容需确认"], ["待确认", "活动"]],
      ["Express Trust Us", "Express Trust Us 分享套餐", "$65pp", "官网提到的 curated set menu，适合不想自己研究菜单的人。", "套餐", ["多种口味"], ["过敏需提前说明"], ["套餐", "省心"]],
      ["Bottomless Saturdays", "周六 bottomless 午餐", "$85pp", "官网提到的周六午餐活动，适合聚会，不适合只想简单吃饭的人。", "套餐/活动", ["多种口味"], ["含酒精选择需确认"], ["活动", "聚餐"]],
      ["Contemporary Japanese Sharing Dishes", "现代日式分享菜", "", "官网定位为 contemporary Japanese cuisine，用澳洲当季食材做分享菜。", "分享菜", ["日式", "鲜味"], ["具体过敏需核对"], ["分享", "待核验"]],
    ], "中高"),
    menuText: "Pork Cigars\nYama Yama's\nExpress Trust Us\nBottomless Saturdays\nContemporary Japanese Sharing Dishes",
  },
  {
    id: "syd-ester",
    name: "Ester Restaurant and Bar",
    nameNote: "中文备注：Ester，Chippendale 柴火炉现代澳餐。适合烤炉菜、海鲜、鹌鹑、虾和创意甜品。",
    area: "Sydney CBD",
    address: "46-52 Meagher Street, Chippendale NSW 2008",
    rating: "4.6",
    note: "官网说明菜单会每天变化，所以这里先放官网示例菜，用户到店前仍要核对。",
    tags: ["现代澳餐", "柴火炉", "官网示例菜单", "菜单会变"],
    curationReason: "入选原因：本地高评价餐厅，官网说明菜单每日变化，但示例菜和地址公开。",
    websiteUri: "https://ester-restaurant.com.au/menus",
    menuSource: "Ester 官网示例菜单/图片菜名",
    menuVerified: true,
    menuDishes: dishRows("Ester 官网示例菜单/图片菜名", [
      ["Crab", "螃蟹菜", "", "官网菜单页示例图片之一；具体做法会变化，到店需核对。", "海鲜/蟹", ["鲜味"], ["甲壳类过敏者避免", "当天做法需确认"], ["海鲜", "待核验"]],
      ["Twice cooked quail, burnt honey glaze", "两次烹调鹌鹑配焦蜂蜜釉", "", "官网图片文件名显示的示例菜，甜咸烤香。", "主菜/禽类", ["烤香", "甜咸"], ["含禽类", "小骨头需注意"], ["特色", "示例菜"]],
      ["Prawns with fermented shrimp paste", "鲜虾配发酵虾酱", "", "官网图片文件名显示的海鲜菜，虾味和发酵鲜味明显。", "海鲜/虾", ["虾鲜味", "发酵咸鲜"], ["虾过敏者避免"], ["海鲜", "示例菜"]],
      ["Blood sausage", "血肠", "", "官网图片文件名显示的肉类菜，内脏/血肠味明显，不适合所有人。", "主菜/肉类", ["浓郁", "肉香"], ["内脏味明显", "含肉类"], ["慎选", "特色"]],
      ["Malawach", "也门风味煎饼 Malawach", "", "官网图片名显示的面饼类菜，适合分享。", "面食/分享", ["面香", "油香"], ["含麸质"], ["分享", "面食"]],
      ["Ice cream", "冰淇淋甜品", "", "官网示例甜品图，具体口味每天可能变化。", "甜品", ["甜", "奶香"], ["含奶制品需确认"], ["甜品", "待核验"]],
    ], "中"),
    menuText: "Crab\nTwice cooked quail, burnt honey glaze\nPrawns with fermented shrimp paste\nBlood sausage\nMalawach\nIce cream",
  },
  {
    id: "syd-mjolner",
    name: "Mjølner Sydney",
    nameNote: "中文备注：Mjølner，Redfern 维京主题肉食餐厅。适合大块肉、骨髓、鳟鱼、威士忌和沉浸式晚餐。",
    area: "Sydney CBD",
    address: "267 Cleveland Street, Redfern NSW 2016",
    rating: "4.5",
    note: "官网说明是 meat-forward menu 和维京主题体验，适合想吃肉和体验感强的用户。",
    tags: ["肉食", "主题餐厅", "官网说明", "真实菜单线索"],
    curationReason: "入选原因：官网地址和菜单方向清楚，Redfern 离 city 近，适合核心悉尼扩展。",
    websiteUri: "https://mjolner.com.au/sydney",
    menuSource: "Mjølner Sydney 官网说明/媒体菜单线索",
    menuVerified: true,
    menuDishes: dishRows("Mjølner Sydney 官网说明/媒体菜单线索", [
      ["Roast Bone Marrow", "烤骨髓", "", "官网媒体介绍提到的菜，味道非常浓郁，适合爱吃肉的人。", "前菜/骨髓", ["浓郁", "油脂香", "肉香"], ["油脂重", "不是所有人能接受"], ["特色", "慎选"]],
      ["Tomahawk Steak", "战斧牛排", "", "官网媒体介绍提到的大块牛排，适合多人分享。", "主菜/牛排", ["牛肉香", "炭烤味"], ["含牛肉", "份量大"], ["分享", "肉食"]],
      ["Grilled Whole Rainbow Trout", "整条烤彩虹鳟鱼", "", "官网媒体介绍提到的整鱼菜，适合喜欢鱼的人。", "主菜/鱼类", ["鱼鲜味", "烤香"], ["鱼刺需注意", "鱼类过敏者避免"], ["鱼", "主菜"]],
      ["Thor's Hammer", "Thor's Hammer 大块肉体验", "", "官网活动菜单方向，通常是大块肉/分享体验，适合聚会。", "套餐/肉食", ["肉香", "浓郁"], ["份量大", "含肉类"], ["体验", "分享"]],
      ["Whisky Bone Luge", "威士忌骨髓体验", "", "官网活动项目，偏酒精和体验感，不适合老人小孩或不喝酒的人。", "体验/酒精", ["酒香", "肉香"], ["含酒精", "油脂重"], ["体验", "慎选"]],
    ], "中"),
    menuText: "Roast Bone Marrow\nTomahawk Steak\nGrilled Whole Rainbow Trout\nThor's Hammer\nWhisky Bone Luge",
  },
];

const sydneyCbdMenuExtensions = {
  "syd-aalia": [
    ["Sydney rock oyster, black lime dressing", "悉尼岩蚝配黑青柠汁", "$42/$78", "AALIA 官方 A La Carte PDF：悉尼岩蚝配黑青柠调味，清爽开胃。", "海鲜/生蚝", ["鲜味", "酸香", "海水味"], ["生食", "贝类过敏者避免"], ["海鲜", "开胃"]],
    ["Sea urchin waraq simsim", "海胆芝麻薄片", "$18 each", "AALIA 官方菜单：海胆、aged rice 和 cumin，味道鲜甜浓郁，适合想尝鲜的人。", "海鲜/小食", ["海胆鲜味", "坚果/芝麻香", "香料味"], ["海鲜过敏者避免", "口味特殊"], ["海胆", "尝鲜"]],
    ["Lamb nayyeh, tabbouleh, sesame butter", "中东生羊肉塔塔配香草沙拉和芝麻黄油", "$34", "AALIA 官方菜单：lamb nayyeh 是生羊肉风格菜，配 tabbouleh 和 sesame butter。", "生食/羊肉", ["肉香", "香草清爽", "芝麻香"], ["生食", "含羊肉", "慎选"], ["中东", "生食"]],
    ["Fattoush cracker", "Fattoush 脆片", "$11 each", "AALIA 官方菜单：把中东 fattoush 沙拉做成脆片小食，适合开场分享。", "小食/蔬菜", ["清爽", "酸香", "酥脆"], ["配料需核对"], ["开胃", "分享"]],
    ["Angelachu anchovies, aish muhammara, macadamia", "凤尾鱼配红椒核桃酱和澳洲坚果", "$13 each", "AALIA 官方菜单：anchovies 咸鲜，muhammara 通常带红椒和坚果香。", "小食/鱼类", ["咸鲜", "红椒香", "坚果香"], ["含鱼", "含坚果"], ["小食", "重口"]],
    ["Bone marrow ful medames", "骨髓蚕豆泥", "$37", "AALIA 官方菜单：把埃及 ful medames 蚕豆菜做成骨髓版本，味道浓郁。", "前菜/豆类", ["豆香", "骨髓油脂香", "浓郁"], ["油脂重", "含动物骨髓"], ["特色", "中东"]],
    ["Moreton bay bug, chicken fat orzo, trout roe", "莫顿湾小龙虾配鸡油米形意面和鳟鱼籽", "$47", "AALIA 官方菜单：甲壳类海鲜配 chicken fat orzo 和 trout roe，鲜味很重。", "海鲜/甲壳类", ["海鲜鲜味", "油脂香", "咸鲜"], ["甲壳类过敏者避免", "含鱼籽"], ["海鲜", "特色"]],
    ["Spanner crab, macadamia tahini, green apple", "蟹肉配澳洲坚果 tahini 和青苹果", "$53", "AALIA 官方菜单：spanner crab 配坚果芝麻酱和青苹果，清爽中带坚果香。", "海鲜/蟹", ["蟹鲜味", "坚果香", "青苹果清爽"], ["甲壳类过敏者避免", "含坚果/芝麻"], ["海鲜", "分享"]],
    ["Dry aged duck, fesenjan", "干式熟成鸭配波斯石榴核桃酱", "$63/$125", "AALIA 官方菜单：fesenjan 是波斯风味石榴核桃酱，酸甜浓郁。", "主菜/鸭肉", ["鸭肉香", "酸甜", "坚果香"], ["含鸭肉", "含核桃"], ["主菜", "波斯风味"]],
    ["Kiwami flank steak MB9+, Cafe de Cairo", "Kiwami 和牛 flank 牛排配 Cairo 风味酱", "$75", "AALIA 官方菜单：高等级和牛 flank steak，适合想吃肉但又想试中东香料的人。", "主菜/牛肉", ["牛肉香", "香料味", "浓郁"], ["含牛肉"], ["牛排", "主菜"]],
    ["Grilled hispi cabbage, tabil tahini, almond", "烤 hispi 卷心菜配香料 tahini 和杏仁", "$24", "AALIA 官方菜单：烤卷心菜配北非香料、芝麻酱和杏仁，适合配肉。", "蔬菜/配菜", ["炭烤香", "芝麻香", "坚果香"], ["含杏仁/芝麻"], ["蔬菜", "配菜"]],
    ["Milk chocolate tart, Egyptian tea, plum", "牛奶巧克力挞配埃及茶和李子", "$24", "AALIA 官方甜品菜单：巧克力挞带茶香和李子酸甜。", "甜品", ["巧克力香", "茶香", "酸甜"], ["含奶制品", "可能含麸质"], ["甜品", "饭后"]],
  ],
  "syd-hubert": [
...
const sydneyCbdAdditionalRestaurants = [
  {
    id: "syd-the-charles",
    name: "The Charles Brasserie & Bar",
    nameNote: "中文备注：The Charles，King Street 高级法式 brasserie。适合牛排、海鲜、鸭、甜品车和正式晚餐。",
    area: "Sydney CBD",
    address: "66 King Street, Sydney NSW 2000",
    rating: "本地热门",
    note: "官网菜单和 2026 PDF 可核验，菜品多，适合不会英文用户提前看懂。",
    tags: ["法式 brasserie", "牛排", "官网 PDF", "真实菜单"],
    curationReason: "入选原因：CBD 核心位置，官网菜单/PDF 完整，菜单对目标用户解释价值高。",
    websiteUri: "https://thecharles.sydney/menu/",
    hasMenu: true,
    menuSource: "The Charles Brasserie 官方 Brasserie ALC PDF, June 2026",
    menuVerified: true,
    menuDishes: dishRows("The Charles Brasserie 官方 Brasserie ALC PDF, June 2026", [
      ["Fruits de mer tartlet", "海鲜小塔", "$15 each", "官方 PDF small bites：蓝鳍金枪鱼、ocean trout 和虾做成的小塔，适合开场。", "小食/海鲜", ["海鲜鲜味", "酥脆"], ["含鱼/虾", "海鲜过敏者避免"], ["开胃", "海鲜"]],
      ["Scallop & abalone beignet", "扇贝鲍鱼炸泡芙", "$17 each", "官方 PDF：pale ale 面糊、seaweed mustard，海鲜味明显。", "小食/海鲜", ["贝类鲜味", "酥脆", "芥末味"], ["贝类过敏者避免", "含麸质"], ["海鲜", "尝鲜"]],
      ["Chicken liver parfait", "鸡肝慕斯", "$35", "官方 PDF：配 pickled peaches 和 fruit loaf，口感顺滑浓郁。", "前菜/内脏", ["浓郁", "肉香", "微甜"], ["内脏味", "含鸡肝"], ["法餐", "慎选"]],
      ["Steak & anchovy tartare", "牛排凤尾鱼塔塔", "$39/$58", "官方 PDF：桌边制作，配传统调味、bagna cauda 和薯片。", "前菜/生牛肉", ["牛肉香", "咸鲜", "酸咸"], ["生食", "含牛肉/鱼"], ["法餐", "慎选"]],
      ["Stuffed lumaconi", "龙虾蟹肉大贝壳意面", "$44", "官方 PDF：lobster、saffron 和 buttered crab，海鲜味很足。", "意面/海鲜", ["龙虾鲜味", "蟹鲜味", "黄油香"], ["甲壳类过敏者避免", "含麸质"], ["意面", "海鲜"]],
      ["Whole dry-aged Aylesbury duck a la Presse", "整只熟成鸭压榨汁", "$190", "官方 PDF：整只 dry-aged Aylesbury duck，配 lentils du puy、dates 和 hazelnuts。", "主菜/鸭肉", ["鸭肉香", "浓郁", "坚果香"], ["含鸭肉", "含榛子", "价格高"], ["分享", "招牌"]],
      ["Wagyu beef & foie gras en croute", "和牛鹅肝酥皮派", "$160", "官方 PDF：蘑菇馅和 Perigueux 酱，法式高级肉菜。", "主菜/牛肉", ["牛肉香", "鹅肝浓郁", "酥皮香"], ["含牛肉", "含鹅肝", "价格高"], ["招牌", "分享"]],
      ["Ocean trout Bouillabaisse", "海鳟鱼布亚贝斯风味", "$56", "官方 PDF：配 shellfish ragu、confit tomato 和 saffron，海鲜汤风味。", "主菜/鱼类", ["鱼鲜味", "番茄味", "藏红花香"], ["鱼/贝类过敏者避免"], ["海鲜", "主菜"]],
      ["Skin-on fries", "带皮薯条", "$16", "官方 PDF sides：简单安全配菜，适合配牛排或汉堡。", "配菜", ["咸香", "酥脆"], ["油炸"], ["配菜", "安全菜"]],
      ["Le grand souffle", "大号甜舒芙蕾", "$34", "官方甜品 PDF：Blackcurrant Mont Blanc 风味，适合饭后分享。", "甜品", ["甜", "莓果香", "轻盈"], ["含鸡蛋", "含奶制品"], ["甜品", "分享"]],
    ]),
    menuText: ["Fruits de mer tartlet", "Scallop & abalone beignet", "Chicken liver parfait", "Steak & anchovy tartare", "Stuffed lumaconi", "Whole dry-aged Aylesbury duck a la Presse", "Wagyu beef & foie gras en croute", "Ocean trout Bouillabaisse", "Skin-on fries", "Le grand souffle"].join("\n"),
  },
  {
    id: "syd-clam-bar",
    name: "Clam Bar",
    nameNote: "中文备注：Clam Bar，Bridge Street 海鲜和牛排 grill。适合生蚝、虾、John Dory、龙虾意面和牛排。",
    area: "Sydney CBD",
    address: "44 Bridge Street, Sydney NSW 2000",
    rating: "本地热门",
    note: "官网 June 2026 PDF 菜单清楚，海鲜和牛排很多，适合做 CBD 核心候选。",
    tags: ["海鲜", "牛排", "官网 PDF", "真实菜单"],
    curationReason: "入选原因：CBD 核心餐厅，官网 PDF 菜单完整，菜名对不会英文用户非常需要解释。",
    websiteUri: "https://www.clambarsydney.com/",
    hasMenu: true,
    menuSource: "Clam Bar 官方 Menu PDF, June 2026",
    menuVerified: true,
    menuDishes: dishRows("Clam Bar 官方 Menu PDF, June 2026", [
      ["Penny's prawn cocktail", "Penny's 冷虾鸡尾酒", "$34", "官方 PDF：tiger prawns 配 cocktail sauce，经典冷海鲜前菜。", "海鲜/虾", ["虾鲜味", "酸甜酱汁"], ["虾过敏者避免", "冷菜"], ["海鲜", "开胃"]],
      ["Oysters Metropole", "Metropole 生蚝拼盘", "$46", "官方 PDF：半打 East Coast oysters 配 lemongrass chipolatas。", "海鲜/生蚝", ["海水味", "香茅肉肠香"], ["生食", "贝类过敏者避免"], ["生蚝", "分享"]],
      ["Tuna tartare", "黄鳍金枪鱼塔塔", "$34", "官方 PDF：yellowfin tuna、condiments 和 beef-fat potatoes。", "海鲜/生食", ["金枪鱼鲜味", "咸香", "土豆香"], ["生食", "鱼类过敏者避免"], ["塔塔", "海鲜"]],
      ["Calamari", "烤鱿鱼配芹菜和辣椒脆", "$36", "官方 PDF：grilled calamari、celery、white anchovy 和 chilli crisp。", "海鲜/鱿鱼", ["鱿鱼鲜味", "微辣", "咸鲜"], ["海鲜过敏者避免", "可能微辣"], ["海鲜", "分享"]],
      ["Dory chop", "带骨 John Dory 鱼排", "$64", "官方 PDF：John Dory bone-in chop，配 tomato 和 scallop XO。", "主菜/鱼类", ["鱼鲜味", "番茄味", "XO 鲜味"], ["鱼/贝类过敏者避免", "有骨"], ["主菜", "海鲜"]],
      ["Lobster spaghetti", "龙虾番茄意面", "$56", "官方 PDF：rock lobster、tomato 和 shellfish bisque。", "意面/龙虾", ["龙虾鲜味", "番茄酸香", "浓郁"], ["甲壳类过敏者避免", "含麸质"], ["意面", "招牌"]],
      ["Clam Bar cheeseburger", "Clam Bar 牛肉芝士汉堡", "$40", "官方 PDF：250g grass-fed beef、American cheese、pickles 和 sesame bun。", "主食/汉堡", ["牛肉香", "芝士香", "酸黄瓜"], ["含牛肉", "含奶制品", "含麸质"], ["安全菜", "主食"]],
      ["Flat iron", "Flat iron 牛排", "$59", "官方 PDF：Southern Grain flat iron 250g，MBS 4。", "主菜/牛排", ["牛肉香", "炭烤味"], ["含牛肉"], ["牛排", "主菜"]],
      ["Macaroni alla vodka", "伏特加酱通心粉", "$21", "官方 PDF sides：奶油番茄伏特加风味通心粉，适合配牛排。", "配菜/意面", ["奶油番茄", "咸香"], ["含奶制品", "含麸质", "可能含酒味"], ["配菜", "意面"]],
      ["Creme brulee", "法式焦糖布丁", "", "官方 banquet PDF 列出 vanilla bean custard creme brulee，经典甜品。", "甜品", ["香草奶香", "焦糖甜"], ["含奶制品", "含鸡蛋"], ["甜品", "饭后"]],
    ]),
    menuText: ["Penny's prawn cocktail", "Oysters Metropole", "Tuna tartare", "Calamari", "Dory chop", "Lobster spaghetti", "Clam Bar cheeseburger", "Flat iron", "Macaroni alla vodka", "Creme brulee"].join("\n"),
  },
  {
    id: "syd-shell-house-menzies",
    name: "Shell House Menzies Bar & Bistro",
    nameNote: "中文备注：Shell House Menzies，CBD 历史建筑里的 bistro/bar。适合海鲜、意面、汉堡、牛排和饭后甜品。",
    area: "Sydney CBD",
    address: "37 Margaret Street, Sydney NSW 2000",
    rating: "本地热门",
    note: "官网页面直接列出 Menzies Bar 菜单，菜品覆盖小食、意面、主菜、甜品。",
    tags: ["Bistro", "海鲜", "官网菜单", "真实菜单"],
    curationReason: "入选原因：Shell House CBD 位置强，官网菜单直接可核验，适合游客/学生/父母来 city 使用。",
    websiteUri: "https://shellhouse.com.au/menzies-bar/menu/",
    hasMenu: true,
    menuSource: "Shell House Menzies Bar 官网菜单",
    menuVerified: true,
    menuDishes: dishRows("Shell House Menzies Bar 官网菜单", [
      ["Menzies Lobster Roll", "Menzies 龙虾卷", "$18", "官网菜单：龙虾卷小食，适合想试海鲜但不想点大菜的人。", "小食/龙虾", ["龙虾鲜味", "面包香"], ["甲壳类过敏者避免", "含麸质"], ["海鲜", "小食"]],
      ["Fried Snapper Sandwich", "炸 snapper 鱼三明治", "$16", "官网菜单：炸鱼三明治，比复杂海鲜主菜更容易点。", "主食/鱼", ["酥脆", "鱼鲜味"], ["鱼类过敏者避免", "含麸质", "油炸"], ["安全菜", "鱼"]],
      ["Raw Scallop, Artichoke, Cotechino Dressing", "生扇贝配洋蓟和 Cotechino 调味", "$26", "官网菜单：生扇贝小盘，口味鲜甜，适合能接受生食的人。", "海鲜/生食", ["扇贝鲜甜", "咸香"], ["生食", "贝类过敏者避免"], ["海鲜", "慎选"]],
      ["Fritto Misto", "意式混合炸海鲜", "$24", "官网菜单：混合炸物配 parsley 和 aioli，适合分享。", "海鲜/炸物", ["酥脆", "海鲜味", "蒜香酱"], ["海鲜过敏者避免", "油炸"], ["分享", "海鲜"]],
      ["Lobster Ravioli", "龙虾意式馄饨", "$32", "官网菜单：樱桃番茄、龙虾酱和辣椒，海鲜味浓。", "意面/龙虾", ["龙虾鲜味", "番茄酸香", "微辣"], ["甲壳类过敏者避免", "含麸质"], ["意面", "海鲜"]],
      ["Candele, Beef Cheek Ragu", "牛脸颊肉酱 Candele 意面", "$36", "官网菜单：beef cheek ragu 配 pecorino romano，肉味浓。", "意面/牛肉", ["牛肉香", "浓郁", "芝士咸香"], ["含牛肉", "含奶制品", "含麸质"], ["意面", "主食"]],
      ["Cioppino of Cod, Clams & Crab", "鳕鱼蛤蜊蟹海鲜炖汤", "$46", "官网菜单：cod、clams、crab 配 potato rouille，海鲜炖菜风格。", "主菜/海鲜", ["海鲜鲜味", "浓郁", "蒜香"], ["鱼/贝/蟹过敏者避免"], ["主菜", "海鲜"]],
      ["Wagyu Beef Burger, Fries", "和牛牛肉汉堡配薯条", "$28", "官网菜单：简单直接的汉堡加薯条，适合看不懂菜单时选。", "主食/汉堡", ["牛肉香", "芝士/酱汁味", "薯条咸香"], ["含牛肉", "含麸质"], ["安全菜", "主食"]],
      ["300G Striploin Black Angus MB3+", "300g 黑安格斯 striploin 牛排", "$55", "官网菜单：Black Angus striploin 配 Sangiovese sauce，适合牛排需求。", "主菜/牛排", ["牛肉香", "红酒酱香"], ["含牛肉", "酱汁可能含酒"], ["牛排", "主菜"]],
      ["Tiramisu, Frangelico", "提拉米苏配榛子利口酒", "$16", "官网甜品：咖啡奶酪甜品，带 Frangelico 榛子酒香。", "甜品", ["咖啡香", "奶香", "榛子酒香"], ["含奶制品", "含咖啡因", "含酒/坚果"], ["甜品", "饭后"]],
    ]),
    menuText: ["Menzies Lobster Roll", "Fried Snapper Sandwich", "Raw Scallop Artichoke Cotechino Dressing", "Fritto Misto", "Lobster Ravioli", "Candele Beef Cheek Ragu", "Cioppino of Cod Clams Crab", "Wagyu Beef Burger Fries", "300G Striploin Black Angus", "Tiramisu Frangelico"].join("\n"),
  },
  {
    id: "syd-gowings",
    name: "Gowings Bar & Grill",
    nameNote: "中文备注：Gowings，QT Sydney 里的意式/纽约牛排馆风格餐厅。适合意面、海鲜、牛排和商务晚餐。",
    area: "Sydney CBD",
    address: "1/49 Market Street, Sydney NSW 2000",
    rating: "本地热门",
    note: "官网 2026 A La Carte PDF 菜单可核验，主打意式海鲜、手工意面和牛排。",
    tags: ["牛排", "意式", "官网 PDF", "真实菜单"],
    curationReason: "入选原因：CBD Market Street 核心位置，官网 PDF 完整，适合城市区第一批内测。",
    websiteUri: "https://www.gowingsbarandgrill.com.au/menus/",
    hasMenu: true,
    menuSource: "Gowings 官方 A La Carte PDF, June 2026",
    menuVerified: true,
    menuDishes: dishRows("Gowings 官方 A La Carte PDF, June 2026", [
      ["Garlic pizzetta, whipped ricotta", "蒜香小披萨配打发 ricotta", "$19", "官方 PDF：小披萨配 ricotta 和野蜂蜜，适合开场分享。", "前菜/面食", ["蒜香", "奶香", "微甜"], ["含奶制品", "含麸质"], ["分享", "开胃"]],
      ["Rock oysters, white balsamic", "岩蚝配白 balsamic", "$8 each", "官方 PDF：rock oysters 配 eschalot 和 chives，清爽海鲜。", "海鲜/生蚝", ["海水味", "酸香"], ["生食", "贝类过敏者避免"], ["海鲜", "开胃"]],
      ["Burrata, fennel marmellata", "Burrata 奶酪配茴香果酱", "$29", "官方 PDF：burrata、fennel marmellata、orange pollen、green oil。", "前菜/奶酪", ["奶香", "橙香", "微甜"], ["含奶制品"], ["素食友好", "奶酪"]],
      ["Tasmanian octopus, tomato nduja sugo", "塔州章鱼配番茄 nduja 酱", "$36", "官方 PDF：章鱼、caponata、lemon、parsley，可能微辣。", "海鲜/章鱼", ["章鱼鲜味", "番茄味", "微辣"], ["海鲜过敏者避免", "可能辣"], ["海鲜", "分享"]],
      ["Potato gnocchi, prawns", "土豆 gnocchi 配虾", "$46", "官方 PDF：prawns、parmesan 和 burnt sage muscadel butter。", "意面/虾", ["虾鲜味", "黄油香", "芝士咸香"], ["虾过敏者避免", "含奶制品/麸质"], ["意面", "海鲜"]],
      ["Chestnut pappardelle, braised rabbit", "栗子宽面配炖兔肉", "$39", "官方 PDF：braised rabbit、chestnut mushroom、parmesan、parsley。", "意面/肉类", ["肉香", "栗子/蘑菇香", "浓郁"], ["含兔肉", "含奶制品/麸质"], ["意面", "特色"]],
      ["T-bone bistecca alla fiorentina", "佛罗伦萨 T 骨牛排", "$198", "官方 PDF：1kg Cape Grim grain fed T-bone，适合多人分享。", "主菜/牛排", ["牛肉香", "炭烤味"], ["含牛肉", "价格高", "份量大"], ["分享", "牛排"]],
      ["Baby barramundi", "小 barramundi 鱼", "$59", "官方 PDF：配 mushrooms、smoked celeriac、guanciale、celery、parsley 和 lemon。", "主菜/鱼类", ["鱼鲜味", "烟熏味", "柠檬清香"], ["鱼类过敏者避免", "含猪肉 guanciale"], ["鱼", "主菜"]],
      ["Duck fat roasted potatoes", "鸭油烤土豆", "$19", "官方 PDF sides：rosemary 和 confit garlic，适合配牛排。", "配菜", ["土豆香", "鸭油香", "蒜香"], ["含动物油脂"], ["配菜", "分享"]],
      ["Pine roasted carrots", "松香烤胡萝卜", "$17", "官方 PDF：honey 和 stracciatella，甜咸奶香。", "配菜/蔬菜", ["甜", "奶香", "烤香"], ["含奶制品", "含蜂蜜"], ["蔬菜", "配菜"]],
    ]),
    menuText: ["Garlic pizzetta whipped ricotta", "Rock oysters white balsamic", "Burrata fennel marmellata", "Tasmanian octopus tomato nduja sugo", "Potato gnocchi prawns", "Chestnut pappardelle braised rabbit", "T-bone bistecca alla fiorentina", "Baby barramundi", "Duck fat roasted potatoes", "Pine roasted carrots"].join("\n"),
  },
  {
    id: "syd-ragazzi",
    name: "Ragazzi Wine + Pasta",
    nameNote: "中文备注：Ragazzi，Angel Place 手工意面和意大利酒吧。适合小盘、crudo、手工 pasta 和甜品。",
    area: "Sydney CBD",
    address: "1 Angel Place, Sydney NSW 2000",
    rating: "本地热门",
    note: "Love Tilly Group 官方 sample food menu PDF 可核验，菜单会随季节变化。",
    tags: ["意面", "意式小食", "官网 PDF", "真实菜单"],
    curationReason: "入选原因：CBD Angel Place 热门意面店，官网菜单清楚，菜名对目标用户较难，需要中文解释。",
    websiteUri: "https://www.lovetillygroup.com/ragazzi-wine-pasta",
    hasMenu: true,
    menuSource: "Ragazzi 官方 sample food menu PDF",
    menuVerified: true,
    menuDishes: dishRows("Ragazzi 官方 sample food menu PDF", [
      ["Sydney Rock Oyster, finger lime, tomato water", "悉尼岩蚝配手指柠檬和番茄水", "$7 each", "官方 PDF：清爽生蚝，适合喜欢海鲜生食的人。", "海鲜/生蚝", ["海水味", "酸香", "清爽"], ["生食", "贝类过敏者避免"], ["开胃", "海鲜"]],
      ["Mushroom & taleggio croquette", "蘑菇 taleggio 奶酪可乐饼", "$9 each", "官方 PDF：蘑菇和意式奶酪炸成小球，外脆内软。", "小食/奶酪", ["酥脆", "菌菇香", "奶香"], ["含奶制品", "油炸"], ["小食", "素食友好"]],
      ["Yellowfin tuna crudo", "黄鳍金枪鱼 crudo", "$29", "官方 PDF：pomegranate、ginger、wasabi，清爽微辛。", "海鲜/生食", ["鱼鲜味", "姜香", "微辛"], ["生食", "鱼类过敏者避免"], ["海鲜", "清爽"]],
      ["Spaghetti cacio e pepe", "黑胡椒芝士意面", "$28", "官方 PDF：经典罗马风味，芝士和黑胡椒是主味。", "意面/芝士", ["芝士香", "黑胡椒香", "咸香"], ["含奶制品", "含麸质"], ["意面", "经典"]],
      ["Pansotti of prawn", "虾馅 pansotti 意面", "$42", "官方 PDF：prawn、garlic 和 shellfish oil，海鲜味明显。", "意面/虾", ["虾鲜味", "蒜香", "贝类油香"], ["虾/贝类过敏者避免", "含麸质"], ["意面", "海鲜"]],
      ["Lumache, spanner crab", "蟹肉 lumache 意面", "$44", "官方 PDF：spanner crab、fermented chilli butter、sea blight。", "意面/蟹", ["蟹鲜味", "黄油香", "微辣"], ["甲壳类过敏者避免", "含奶制品/麸质"], ["意面", "海鲜"]],
      ["Tagliatelle, beef cheek", "牛脸颊宽面", "$38", "官方 PDF：beef cheek、cime di rapa、horseradish，肉味浓。", "意面/牛肉", ["牛肉香", "浓郁", "微辛"], ["含牛肉", "含麸质"], ["意面", "主食"]],
      ["Brussels sprouts, garlic, walnut", "抱子甘蓝配蒜、核桃和苹果 balsamic", "$16", "官方 PDF：适合配意面和肉菜。", "配菜/蔬菜", ["蒜香", "坚果香", "酸甜"], ["含核桃"], ["配菜", "蔬菜"]],
      ["Ricotta panna cotta", "Ricotta 奶冻配梨和蜂巢糖", "$17", "官方甜品 PDF：poached pear 和 honeycomb，口感软滑。", "甜品", ["奶香", "梨香", "甜"], ["含奶制品"], ["甜品", "饭后"]],
      ["Hazelnut & almond tiramisu", "榛子杏仁提拉米苏", "$20", "官方甜品 PDF：坚果版提拉米苏，咖啡奶香和坚果香明显。", "甜品", ["咖啡香", "奶香", "坚果香"], ["含榛子/杏仁", "含奶制品", "含咖啡因"], ["甜品", "坚果"]],
    ]),
    menuText: ["Sydney Rock Oyster finger lime tomato water", "Mushroom taleggio croquette", "Yellowfin tuna crudo", "Spaghetti cacio e pepe", "Pansotti of prawn", "Lumache spanner crab", "Tagliatelle beef cheek", "Brussels sprouts garlic walnut", "Ricotta panna cotta", "Hazelnut almond tiramisu"].join("\n"),
  },
  {
    id: "syd-fabbrica",
    name: "Fabbrica Sydney CBD",
    nameNote: "中文备注：Fabbrica，King Street 休闲手工意面店。适合午餐、三明治、意面和小食。",
    area: "Sydney CBD",
    address: "161 King Street, Sydney NSW 2000",
    rating: "本地热门",
    note: "Love Tilly Group 官方 lunch/dinner PDF 可核验，适合 CBD 轻松吃意面。",
    tags: ["意面", "休闲", "官网 PDF", "真实菜单"],
    curationReason: "入选原因：CBD 核心位置，菜单清楚，价格相对比 fine dining 友好。",
    websiteUri: "https://www.lovetillygroup.com/fabbrica/sydney-cbd",
    hasMenu: true,
    menuSource: "Fabbrica CBD 官方 Lunch/Dinner PDF, June 2026",
    menuVerified: true,
    menuDishes: dishRows("Fabbrica CBD 官方 Lunch/Dinner PDF, June 2026", [
      ["Sourdough, cultured butter", "酸面包配发酵黄油", "$7", "官方 PDF：简单开场面包，适合分享。", "小食/面包", ["面香", "黄油香"], ["含麸质", "含奶制品"], ["开胃", "分享"]],
      ["Zucchini flower, mozzarella, ricotta, chilli honey", "西葫芦花配 mozzarella、ricotta 和辣蜂蜜", "$8 each", "官方 PDF：炸/填馅西葫芦花，奶香微甜微辣。", "小食/奶酪", ["奶香", "微甜", "微辣"], ["含奶制品", "含蜂蜜"], ["小食", "素食友好"]],
      ["Tuna Crudo, tomato, creme fraiche, sesame oil", "金枪鱼 crudo 配番茄、酸奶油和芝麻油", "$26", "官方 PDF：生金枪鱼小盘，味道清爽带芝麻香。", "海鲜/生食", ["鱼鲜味", "番茄清爽", "芝麻香"], ["生食", "鱼类过敏者避免"], ["海鲜", "清爽"]],
      ["Arancini", "意式炸饭团", "$12", "官方 PDF：2 个 arancini，适合不想冒险的小食。", "小食/炸物", ["酥脆", "米香", "咸香"], ["油炸", "可能含奶制品"], ["小食", "安全菜"]],
      ["Spaghetti cacio e pepe", "黑胡椒芝士意面", "$28", "官方 PDF：经典芝士黑胡椒意面，可加 truffle。", "意面/芝士", ["芝士香", "黑胡椒香"], ["含奶制品", "含麸质"], ["意面", "经典"]],
      ["Mafaldine, prawns, kombu butter", "虾仁昆布黄油 mafaldine 意面", "$36", "官方 PDF：虾、kombu butter，鲜味和黄油香明显。", "意面/虾", ["虾鲜味", "黄油香", "海藻鲜味"], ["虾过敏者避免", "含奶制品/麸质"], ["海鲜", "意面"]],
      ["Tonnarelli, blue swimmer crab, chilli", "蓝花蟹辣味 tonnarelli 意面", "$38", "官方 PDF：blue swimmer crab 和 chilli，海鲜味偏重。", "意面/蟹", ["蟹鲜味", "微辣"], ["甲壳类过敏者避免", "含麸质"], ["意面", "海鲜"]],
      ["Semolina casarecce, pork sausage ragu, kale", "猪肉香肠肉酱 casarecce 意面", "$34", "官方 PDF：pork sausage ragu 和 kale，肉味浓。", "意面/猪肉", ["肉香", "咸香", "蔬菜味"], ["含猪肉", "含麸质"], ["意面", "主食"]],
      ["Chicken schnitzel sandwich", "炸鸡排三明治", "$24", "官方 lunch PDF：鸡排、almond romesco 和 rocket，配薯条/酸黄瓜。", "三明治/鸡肉", ["酥脆", "鸡肉香", "坚果酱香"], ["含鸡肉", "含杏仁", "含麸质"], ["午餐", "安全菜"]],
      ["Hazelnut tiramisu", "榛子提拉米苏", "$18", "官方 PDF：榛子风味提拉米苏，适合饭后分享。", "甜品", ["咖啡香", "奶香", "榛子香"], ["含榛子", "含奶制品", "含咖啡因"], ["甜品", "饭后"]],
    ]),
    menuText: ["Sourdough cultured butter", "Zucchini flower mozzarella ricotta chilli honey", "Tuna Crudo tomato creme fraiche sesame oil", "Arancini", "Spaghetti cacio e pepe", "Mafaldine prawns kombu butter", "Tonnarelli blue swimmer crab chilli", "Semolina casarecce pork sausage ragu kale", "Chicken schnitzel sandwich", "Hazelnut tiramisu"].join("\n"),
  },
  {
    id: "syd-palazzo-salato",
    name: "Palazzo Salato",
    nameNote: "中文备注：Palazzo Salato，Clarence Street 罗马 trattoria 风格意餐。适合手工意面、crudo、牛排和甜品。",
    area: "Sydney CBD",
    address: "201/203 Clarence Street, Sydney NSW 2000",
    rating: "本地热门",
    note: "Love Tilly Group 官方 PDF 菜单可核验，菜品比 Ragazzi 更正式。",
    tags: ["意餐", "手工意面", "官网 PDF", "真实菜单"],
    curationReason: "入选原因：CBD 核心意餐，官网菜单完整，菜品名称复杂，中文解释价值高。",
    websiteUri: "https://www.lovetillygroup.com/palazzo-salato",
    hasMenu: true,
    menuSource: "Palazzo Salato 官方 food menu PDF",
    menuVerified: true,
    menuDishes: dishRows("Palazzo Salato 官方 food menu PDF", [
      ["Sydney rock oysters, vermouth jelly", "悉尼岩蚝配 vermouth 果冻", "$7 each", "官方 PDF：可选自然风味或 vermouth jelly，适合海鲜开场。", "海鲜/生蚝", ["海水味", "微酒香", "清爽"], ["生食", "贝类过敏者避免", "可能有酒味"], ["海鲜", "开胃"]],
      ["Bluefin tuna crudo", "蓝鳍金枪鱼 crudo", "$28", "官方 PDF：pickled fennel、cumquats、buckwheat，清爽酸香。", "海鲜/生食", ["鱼鲜味", "酸香", "荞麦香"], ["生食", "鱼类过敏者避免"], ["海鲜", "清爽"]],
      ["Stracciatella, Cantabrian anchovies", "Stracciatella 奶酪配坎塔布连凤尾鱼", "$29", "官方 PDF：奶香和咸鲜鱼味结合，适合分享。", "前菜/奶酪鱼类", ["奶香", "咸鲜", "面包碎香"], ["含奶制品", "含鱼"], ["分享", "意餐"]],
      ["Marron alla griglia", "烤 marron 小龙虾", "$62", "官方 PDF：shellfish butter 和 samphire，海鲜味浓。", "海鲜/甲壳类", ["小龙虾鲜味", "黄油香", "海菜咸鲜"], ["甲壳类过敏者避免", "含奶制品"], ["海鲜", "高级"]],
      ["Scarpinocc of pumpkin", "南瓜 Scarpinocc 意饺", "$39", "官方 PDF：hazelnuts、Pecorino、sage，甜香奶酪味。", "意面/素食", ["南瓜甜", "坚果香", "鼠尾草香"], ["含榛子", "含奶制品/麸质"], ["意面", "素食友好"]],
      ["Mafaldine, spanner crab, uni butter", "蟹肉海胆黄油 mafaldine 意面", "$45", "官方 PDF：spanner crab、uni butter、chilli、sea blight。", "意面/海鲜", ["蟹鲜味", "海胆鲜味", "微辣"], ["甲壳类/海鲜过敏者避免", "含奶制品/麸质"], ["意面", "招牌"]],
      ["Agnolotti dal plin", "猪肉梅干开心果 agnolotti", "$39", "官方 PDF：Wessex Saddleback pig、prune、pistacchio。", "意面/猪肉", ["猪肉香", "果干甜", "坚果香"], ["含猪肉", "含开心果", "含麸质"], ["意面", "特色"]],
      ["Rangers Valley top sirloin MB5+", "Rangers Valley 西冷牛排", "$49", "官方 PDF：配 Salato butter，适合想点直接牛排的人。", "主菜/牛排", ["牛肉香", "黄油香"], ["含牛肉", "含奶制品"], ["牛排", "主菜"]],
      ["Salted dark chocolate tart", "盐味黑巧克力挞", "$21", "官方甜品 PDF：配 vanilla gelato，甜中带一点咸。", "甜品", ["巧克力香", "甜咸", "香草奶香"], ["含奶制品", "可能含麸质"], ["甜品", "饭后"]],
      ["Rice pudding, truffle, hazelnut gelato", "米布丁配松露和榛子冰淇淋", "$32", "官方甜品 PDF：truffle、hazelnut gelato、raw honey，甜品里带松露香。", "甜品", ["奶香", "榛子香", "松露香"], ["含榛子", "含奶制品"], ["甜品", "特色"]],
    ]),
    menuText: ["Sydney rock oysters vermouth jelly", "Bluefin tuna crudo", "Stracciatella Cantabrian anchovies", "Marron alla griglia", "Scarpinocc of pumpkin", "Mafaldine spanner crab uni butter", "Agnolotti dal plin", "Rangers Valley top sirloin", "Salted dark chocolate tart", "Rice pudding truffle hazelnut gelato"].join("\n"),
  },
  {
    id: "syd-letra-house",
    name: "Letra House",
    nameNote: "中文备注：Letra House，Palazzo 楼下的西班牙风格地下酒吧餐厅。适合 tapas、火腿、海鲜饭锅巴和深夜小食。",
    area: "Sydney CBD",
    address: "Rear, 344 Kent Street, Sydney NSW 2000",
    rating: "本地热门",
    note: "Love Tilly Group 官方 PDF 菜单可核验，Spanish-leaning，适合小盘分享。",
    tags: ["西班牙风格", "Tapas", "官网 PDF", "真实菜单"],
    curationReason: "入选原因：CBD 地下 wine bar/restaurant，官网菜单清楚，适合不会英文用户提前理解 tapas。",
    websiteUri: "https://www.lovetillygroup.com/letra-house",
    hasMenu: true,
    menuSource: "Letra House 官方 food menu PDF",
    menuVerified: true,
    menuDishes: dishRows("Letra House 官方 food menu PDF", [
      ["Jamon Serrano", "Serrano 西班牙火腿", "$26", "官方 PDF：西班牙风干火腿，咸香，适合下酒分享。", "冷盘/火腿", ["咸香", "肉香"], ["含猪肉"], ["分享", "西班牙"]],
      ["Raw scampi tostada", "生 scampi 海螯虾 tostada", "$14 each", "官方 PDF：raw scampi 和 paprika，适合能接受生海鲜的人。", "海鲜/生食", ["海鲜鲜甜", "烟熏椒粉香"], ["生食", "甲壳类过敏者避免"], ["海鲜", "慎选"]],
      ["Anchovy, donut, manchego custard", "凤尾鱼甜甜圈配 manchego 奶酪酱", "$9 each", "官方 PDF：咸鲜凤尾鱼配奶酪 custard，口味特别。", "小食/鱼类奶酪", ["咸鲜", "奶香", "甜咸"], ["含鱼", "含奶制品", "含麸质"], ["Tapas", "特色"]],
      ["Croqueta of Jamon Iberico, Manchego", "伊比利亚火腿 Manchego 可乐饼", "$9 each", "官方 PDF：火腿和奶酪炸小食，适合分享。", "小食/炸物", ["酥脆", "火腿咸香", "奶香"], ["含猪肉", "含奶制品", "油炸"], ["Tapas", "分享"]],
      ["Tortilla de patatas, alioli", "西班牙土豆蛋饼配蒜香蛋黄酱", "$28", "官方 PDF：经典 Spanish tortilla，土豆和鸡蛋为主，比较稳。", "主食/鸡蛋土豆", ["蛋香", "土豆香", "蒜香"], ["含鸡蛋", "含蒜味"], ["安全菜", "西班牙"]],
      ["Socarrat, firefly squid, vongole, mussels", "西班牙锅巴饭配萤乌贼、蛤蜊和青口", "$39", "官方 PDF：socarrat 是类似 paella 锅底焦香米饭，海鲜味明显。", "米饭/海鲜", ["锅巴香", "海鲜鲜味", "黄油酸香"], ["海鲜过敏者避免", "贝类过敏者避免"], ["招牌", "海鲜"]],
      ["Cobia, burnt leek salsa, gordal olives", "Cobia 鱼配烤葱 salsa 和 Gordal 橄榄", "$64", "官方 PDF：鱼肉主菜，橄榄和烤葱味明显。", "主菜/鱼类", ["鱼鲜味", "橄榄咸香", "烤葱香"], ["鱼类过敏者避免"], ["主菜", "海鲜"]],
      ["Pressed lamb shoulder", "压制羊肩肉配土豆泥和 salsa verde", "$58", "官方 PDF：羊肩肉、pomme puree 和 salsa verde，肉味浓。", "主菜/羊肉", ["羊肉香", "草本香", "浓郁"], ["含羊肉", "可能含奶制品"], ["主菜", "肉食"]],
      ["Poached rhubarb custard tart", "大黄 custard 挞", "$23", "官方 PDF：配 black pepper chantilly，酸甜奶香。", "甜品", ["酸甜", "奶香", "微胡椒香"], ["含奶制品", "含麸质"], ["甜品", "饭后"]],
      ["Queso, pistachio & persimmon mille-feuille", "奶酪开心果柿子千层酥", "$24", "官方 PDF：甜品，开心果和柿子风味。", "甜品", ["奶香", "开心果香", "果香"], ["含开心果", "含奶制品", "含麸质"], ["甜品", "坚果"]],
    ]),
    menuText: ["Jamon Serrano", "Raw scampi tostada", "Anchovy donut manchego custard", "Croqueta of Jamon Iberico Manchego", "Tortilla de patatas alioli", "Socarrat firefly squid vongole mussels", "Cobia burnt leek salsa gordal olives", "Pressed lamb shoulder", "Poached rhubarb custard tart", "Queso pistachio persimmon mille-feuille"].join("\n"),
  },
  {
    id: "syd-bennelong",
    name: "Bennelong Restaurant & Bar",
    nameNote: "中文备注：Bennelong，悉尼歌剧院内现代澳餐。适合游客、纪念日、澳洲食材和 Opera House 体验。",
    area: "Sydney CBD / Circular Quay",
    address: "Sydney Opera House, Bennelong Point, Sydney NSW 2000",
    rating: "本地名店",
    note: "官网 2026 Counter A La Carte 和 Bar Food PDF 可核验，菜品价格高，适合特殊场合。",
    tags: ["现代澳餐", "歌剧院", "官网 PDF", "真实菜单"],
    curationReason: "入选原因：悉尼核心地标餐厅，官方菜单完整，游客和父母来 Sydney 时很可能会考虑。",
    websiteUri: "https://www.bennelong.com.au/menu/",
    hasMenu: true,
    menuSource: "Bennelong 官方 Counter ALC / Bar Food PDF, 2026",
    menuVerified: true,
    menuDishes: dishRows("Bennelong 官方 Counter ALC / Bar Food PDF, 2026", [
      ["Black River Imperial Oscietra Caviar", "Black River 鱼子酱", "$84-$252", "官方 PDF：鱼子酱配 creme fraiche 和 buckwheat pikelets，价格高。", "海鲜/鱼子酱", ["咸鲜", "奶香"], ["鱼类过敏者避免", "价格高"], ["高级", "特殊场合"]],
      ["Sydney Rock oysters, lemon pepper granita", "悉尼岩蚝配柠檬胡椒冰沙", "$9 each/$54 half dozen", "官方 PDF：生蚝配柠檬胡椒 granita，清爽。", "海鲜/生蚝", ["海水味", "柠檬清爽", "胡椒香"], ["生食", "贝类过敏者避免"], ["海鲜", "开胃"]],
      ["Chestnut, truffle and shiitake arancini", "栗子松露香菇炸饭团", "$13", "官方 PDF：两颗 arancini，菌菇和松露香，适合开场。", "小食/炸物", ["菌菇香", "松露香", "酥脆"], ["油炸", "可能含奶制品"], ["小食", "素食友好"]],
      ["Prawn toast, fermented chilli", "虾吐司配发酵辣椒", "$18", "官方 PDF：两份虾吐司，带发酵辣椒味。", "小食/虾", ["虾鲜味", "酥脆", "微辣"], ["虾过敏者避免", "含麸质"], ["小食", "海鲜"]],
      ["Western Australian marron", "西澳 marron 小龙虾", "$60", "官方 PDF：finger lime、cultured cream、ume 和 buckwheat pikelets。", "海鲜/甲壳类", ["小龙虾鲜味", "酸香", "奶香"], ["甲壳类过敏者避免", "含奶制品"], ["海鲜", "高级"]],
      ["Aquna Murray Cod", "Aquna Murray cod 鱼", "$75", "官方 PDF：garden greens、lemon and fennel puree，清爽鱼主菜。", "主菜/鱼类", ["鱼鲜味", "柠檬清香", "茴香味"], ["鱼类过敏者避免"], ["鱼", "主菜"]],
      ["Raviolo of chestnut and ricotta", "栗子 ricotta 大馄饨", "$45", "官方 PDF：black garlic 和 Jerusalem artichoke，偏素食主菜。", "意面/素食", ["栗子甜香", "奶香", "黑蒜味"], ["含奶制品", "含麸质"], ["素食友好", "主菜"]],
      ["Pure bred Black Angus", "纯种黑安格斯牛肉", "$98", "官方 PDF：parsley、kombu、horseradish、maitake mushrooms。", "主菜/牛肉", ["牛肉香", "鲜味", "山葵微辛"], ["含牛肉"], ["牛排", "主菜"]],
      ["Creme Caramel, Pineapple, Lime, Vanilla", "焦糖布丁配菠萝、青柠和香草", "$35", "官方 PDF：经典布丁甜品，酸甜奶香。", "甜品", ["焦糖甜", "菠萝酸甜", "香草奶香"], ["含奶制品", "含鸡蛋"], ["甜品", "饭后"]],
      ["Sour Cherry, Dark Chocolate, Almond", "酸樱桃黑巧克力杏仁甜品", "$35", "官方 PDF：酸樱桃、黑巧克力和杏仁组合。", "甜品", ["巧克力香", "酸樱桃", "杏仁香"], ["含杏仁", "可能含奶制品"], ["甜品", "坚果"]],
    ]),
    menuText: ["Black River Imperial Oscietra Caviar", "Sydney Rock oysters lemon pepper granita", "Chestnut truffle shiitake arancini", "Prawn toast fermented chilli", "Western Australian marron", "Aquna Murray Cod", "Raviolo of chestnut and ricotta", "Pure bred Black Angus", "Creme Caramel Pineapple Lime Vanilla", "Sour Cherry Dark Chocolate Almond"].join("\n"),
  },
  {
    id: "syd-bopp-tone",
    name: "Bopp & Tone",
    nameNote: "中文备注：Bopp & Tone，Wynyard 附近澳式地中海 grill。适合木火烤肉、海鲜、意面、牛排和多人分享。",
    area: "Sydney CBD",
    address: "60 Carrington Street, Sydney NSW 2000",
    rating: "本地好评",
    note: "官网直接列出 Lunch & Dinner 菜单，菜品丰富，适合 CBD 第一批真实菜单。",
    tags: ["澳式地中海", "牛排", "海鲜", "官网菜单"],
    curationReason: "入选原因：Wynyard 核心位置，官网菜单完整，官网显示曾获 steak restaurant 奖项和 5 plate rating。",
    websiteUri: "https://boppandtone.com.au/menus/",
    hasMenu: true,
    menuSource: "Bopp & Tone 官网 Lunch & Dinner menu",
    menuVerified: true,
    menuDishes: dishRows("Bopp & Tone 官网 Lunch & Dinner menu", [
      ["Sydney Rock oysters, verjus mignonette", "悉尼岩蚝配 verjus mignonette", "$45 half/$90 dozen", "官网菜单：澳洲岩蚝，清爽酸汁，适合喜欢生蚝的人。", "海鲜/生蚝", ["海水味", "酸香"], ["生食", "贝类过敏者避免"], ["海鲜", "开胃"]],
      ["Stuffed zucchini flowers", "填馅西葫芦花", "$12 each", "官网菜单：preserved lemon、ricotta，轻食小盘。", "小食/蔬菜奶酪", ["奶香", "柠檬清香"], ["含奶制品"], ["素食友好", "小食"]],
      ["Bermagui Yellowfin tuna tartare", "Bermagui 黄鳍金枪鱼塔塔", "$32", "官网菜单：cucumber、whipped tahini、seaweed salsa、wasabi peas。", "海鲜/生食", ["鱼鲜味", "芝麻香", "芥末豆脆"], ["生食", "鱼类过敏者避免", "含芝麻"], ["海鲜", "清爽"]],
      ["Westholme Steak tartare", "Westholme 牛排塔塔", "$34", "官网菜单：capers、mustard、cornichons、crispy potato、egg yolk。", "生食/牛肉", ["牛肉香", "酸咸", "芥末味"], ["生食", "含牛肉/鸡蛋"], ["慎选", "牛肉"]],
      ["Australian king prawn conchiglie", "澳洲大虾贝壳意面", "$39", "官网菜单：fermented chilli、parsley、dill，鲜味微辣。", "意面/虾", ["虾鲜味", "微辣", "香草味"], ["虾过敏者避免", "含麸质"], ["意面", "海鲜"]],
      ["Bass Strait octopus bomba rice", "巴斯海峡章鱼 bomba 米饭", "$45", "官网菜单：saffron aioli、shellfish oil，类似海鲜米饭风味。", "米饭/海鲜", ["章鱼鲜味", "藏红花香", "贝类油香"], ["海鲜过敏者避免"], ["海鲜", "主食"]],
      ["Westholme Wagyu beef cheek", "Westholme 和牛牛脸颊", "$62", "官网菜单：mashed potatoes 和 horseradish gremolata，软烂浓郁。", "主菜/牛肉", ["牛肉香", "浓郁", "山葵微辛"], ["含牛肉", "可能含奶制品"], ["主菜", "肉食"]],
      ["Angus tenderloin", "安格斯 tenderloin 牛排", "$72", "官网菜单：250g grass fed Riverine NSW MB3，适合想吃直接牛排的人。", "主菜/牛排", ["牛肉香", "炭烤味"], ["含牛肉"], ["牛排", "主菜"]],
      ["Roast cracked potatoes", "烤裂土豆配香草黄油", "$17", "官网菜单：适合配牛排和海鲜。", "配菜", ["土豆香", "黄油香", "香草味"], ["含奶制品"], ["配菜", "分享"]],
      ["Valrhona 64% chocolate moelleux", "Valrhona 64% 巧克力熔心蛋糕", "$24", "官网菜单：配 vanilla parfait 和 salted macadamia caramel。", "甜品", ["巧克力香", "甜", "澳洲坚果焦糖香"], ["含坚果", "含奶制品"], ["甜品", "饭后"]],
    ]),
    menuText: ["Sydney Rock oysters verjus mignonette", "Stuffed zucchini flowers", "Bermagui Yellowfin tuna tartare", "Westholme Steak tartare", "Australian king prawn conchiglie", "Bass Strait octopus bomba rice", "Westholme Wagyu beef cheek", "Angus tenderloin", "Roast cracked potatoes", "Valrhona chocolate moelleux"].join("\n"),
  },
];

sydneyCbdRestaurants.push(...sydneyCbdAdditionalRestaurants);
...
function localNearbyRestaurants(payload = {}) {
  ...
  if (/^(sydney|sydneycbd|cbd|city|surryhills|therocks|redfern|chippendale)$/i.test(areaKey)) {
    return {
      source: "static_known",
      message: "Sydney CBD 先显示 10 家核心悉尼真实餐厅；优先官网菜单、非中文环境和可导航地址。",
      restaurants: sydneyCbdRestaurants,
    };
  }
