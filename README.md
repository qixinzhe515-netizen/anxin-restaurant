...
- v47 keeps the first screen app-like: no large hero/header or numbered step bar, common area chips sit under the area input, and mobile left-swipe returns to the previous page.
